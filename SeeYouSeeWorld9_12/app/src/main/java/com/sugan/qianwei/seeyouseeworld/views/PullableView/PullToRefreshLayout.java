package com.sugan.qianwei.seeyouseeworld.views.PullableView;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        if (pullDownY > 0) {
            ...
            }.sendEmptyMessageDelayed(0, (refreshResult == SUCCEED) ? 0 : 1000);
        } else {
            changeState(DONE);
            hide();
        }
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                break;
            case LOADED_ALL:
                Log.d("qianwei", "loadmoreFinish: ");
                loadStateImageView.setVisibility(View.VISIBLE);
                loadStateTextView.setText(R.string.refresh_all);
